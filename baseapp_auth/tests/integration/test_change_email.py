...
class TestChangeEmailRequest(ApiMixin):
    ...
    def test_guest_cant_request(self, client, data) -> None:
        r = client.post(self.reverse(), data)
        h.responseUnauthorized(r)

    def test_user_can_request(self, user_client, data, deep_link_mock_success) -> None:
        r = user_client.post(self.reverse(), data)
        h.responseOk(r)

    def test_user_can_request_when_deep_link_errors(
        self, user_client, data, deep_link_mock_error
    ) -> None:
        r = user_client.post(self.reverse(), data)
        h.responseOk(r)

    def test_new_email_cant_be_in_use(self, user_client, data) -> None:
        """
    ...
    def test_sets_user_new_email(self, user_client, data, deep_link_mock_success) -> None:
        r = user_client.post(self.reverse(), data)
        h.responseOk(r)
        user_client.user.refresh_from_db()
        assert user_client.user.new_email == data["new_email"]

    def test_sets_user_new_email_with_lowercase(
        self, user_client, data, deep_link_mock_success
    ) -> None:
...
class TestChangeEmailConfirm(ApiMixin):
    ...
    def test_guest_can_confirm(self, client, data, deep_link_mock_success) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
    ...
    def test_guest_cant_confirm_with_expired_token(self, client, data) -> None:
        time.sleep(1.1)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)

    def test_guest_can_confirm_deep_link_error(self, client, data, deep_link_mock_error) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)

    def test_sets_users_is_new_email_confirmed(self, client, data, deep_link_mock_success) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        self.user.refresh_from_db()
        assert self.user.is_new_email_confirmed

    def test_sends_an_email_to_users_new_email(
        self, client, data, outbox, deep_link_mock_success
    ) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        self.user.refresh_from_db()
    ...
    def test_when_user_doesnt_exist(self, client, data) -> None:
        r = client.post(self.reverse(kwargs={"pk": self.user.id + 1}), data)
        h.responseBadRequest(r)

    def test_when_invalid_token(self, client, data) -> None:
        data["token"] = "1234"
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)

    def test_cant_confirm_twice(self, client, data, deep_link_mock_success) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)
...
class TestChangeEmailVerify(ApiMixin):
    ...
    def test_guest_can_verify(self, client, data) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)

    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(seconds=1))
    def test_guest_cant_verify_with_expired_token(self, client, data) -> None:
        time.sleep(1.1)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)

    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(minutes=5))
    def test_changes_users_email(self, client, data) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        self.user.refresh_from_db()
    ...
    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(seconds=1))
    def test_cant_change_users_email_with_expired_token(self, client, data) -> None:
        time.sleep(1.1)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)
        self.user.refresh_from_db()
    ...
    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(minutes=5))
    def test_resets_users_new_email(self, client, data) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        self.user.refresh_from_db()
    ...
    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(seconds=1))
    def test_dont_reset_users_new_email(self, client, data) -> None:
        time.sleep(1.1)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)
        self.user.refresh_from_db()
    ...
    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(minutes=5))
    def test_resets_users_is_new_email_confirmed(self, client, data) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        self.user.refresh_from_db()
    ...
    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(seconds=1))
    def test_dont_users_is_new_email_confirmed(self, client, data) -> None:
        time.sleep(1.1)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)
        self.user.refresh_from_db()
    ...
    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(minutes=5))
    def test_users_is_email_verified_set(self, client, data) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        self.user.refresh_from_db()
    ...
    @override_settings(BA_AUTH_CHANGE_EMAIL_VERIFY_TOKEN_EXPIRATION_TIME_DELTA=timedelta(seconds=1))
    def test_users_is_email_verified_not_set(self, client, data) -> None:
        time.sleep(1.1)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)
        self.user.refresh_from_db()
    ...
    def test_cant_verify_twice(self, client, data) -> None:
        r = client.post(self.reverse(), data)
        h.responseOk(r)
        r = client.post(self.reverse(), data)
        h.responseBadRequest(r)
...
class TestChangeEmailResendConfirm(ApiMixin):
    ...
    def test_user_cant_resend_if_user_has_no_new_email(self, user_client) -> None:
        r = user_client.post(self.reverse())
        h.responseBadRequest(r)

    def test_user_cant_resend_if_new_email_is_already_confirmed(self, client) -> None:
...
class TestChangeEmailResendVerify(ApiMixin):
    ...
    def test_user_cant_resend_if_their_new_email_is_not_confirmed(self, client) -> None:
...
class TestChangeEmailCancel(ApiMixin):
    ...
    def test_guest_cant_cancel(self, client) -> None:
        r = client.post(self.reverse())
        h.responseUnauthorized(r)

    def test_user_can_cancel(self, client) -> None:
        user = UserFactory(new_email="new@example.com", is_new_email_confirmed=True)
        client.force_authenticate(user)
        r = client.post(self.reverse())
        h.responseOk(r)

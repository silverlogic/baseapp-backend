...
def test_user_cant_delete_page(graphql_user_client) -> None:
    page = PageFactory()
...
def test_superuser_can_delete_page(django_user_client, graphql_user_client) -> None:
...
def test_owner_can_delete_page(django_user_client, graphql_user_client) -> None:
...
def test_user_with_permission_can_delete_page(django_user_client, graphql_user_client) -> None:

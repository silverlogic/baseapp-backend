        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="\n            IF NEW.profile_id IS NOT NULL THEN\n                UPDATE profiles_profile SET name = TRIM(COALESCE(NEW.first_name || ' ' || NEW.last_name, '')), modified = NOW() WHERE id = NEW.profile_id;\n            END IF;\n            RETURN NULL;\n        ",
                    hash="5822f9de4dc4080c51294ed6ef4a05b43b61f208",

# Generated by Django 5.1.13 on 2025-10-23 01:51
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func='INSERT INTO "comments_commentevent" ("body", "created", "files_count", "id", "in_reply_to_id", "is_comments_enabled", "is_edited", "is_pinned", "is_reactions_enabled", "language", "pgh_context_id", "pgh_created_at", "pgh_label", "pgh_obj_id", "profile_id", "reports_count", "status", "target_content_type_id", "target_object_id", "user_id") VALUES (NEW."body", NEW."created", NEW."files_count", NEW."id", NEW."in_reply_to_id", NEW."is_comments_enabled", NEW."is_edited", NEW."is_pinned", NEW."is_reactions_enabled", NEW."language", _pgh_attach_context(), NOW(), \'insert\', NEW."id", NEW."profile_id", NEW."reports_count", NEW."status", NEW."target_content_type_id", NEW."target_object_id", NEW."user_id"); RETURN NULL;',
                    hash="df0ee9ef0e5b406cca2445ee50be3b0dd7ccae0c",
                    operation="INSERT",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="3d50065ac9b6ec0db13758b80b7fa476fb353757",
                    operation="UPDATE",
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash="159f95a11158321e3ca6bda760981fa49d0a33e6",
                    operation="DELETE",

...
@pytest.fixture
def mock_config_blocklisted_words() -> Generator[None, None, None]:
...
def test_blocked_words_validator_no_errors(mock_config_blocklisted_words) -> None:
...
def test_blocked_words_validator_with_errors(mock_config_blocklisted_words) -> None:
...
def test_blocked_words_validator_with_errors_case_insensitive(
    mock_config_blocklisted_words,
) -> None:

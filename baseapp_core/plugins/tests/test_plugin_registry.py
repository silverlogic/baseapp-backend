...
class TestPluginRegistry:
    ...
    def test_load_from_installed_apps_loads_plugins(self) -> None:
        registry = PluginRegistry()
    ...
    def test_load_from_installed_apps_idempotent(self) -> None:
    ...
    def test_load_from_installed_apps_with_empty_list_skips_all_plugins(self) -> None:
        registry = PluginRegistry()
        registry.load_from_installed_apps(installed_apps=[])
        assert registry._initialized is True
        assert len(registry._plugins) == 0

    def test_load_from_installed_apps_with_app_list_validates_against_list(self) -> None:
    ...
    def test_load_from_installed_apps_with_list_loads_matching_plugins_only(self) -> None:
        registry = PluginRegistry()
        registry.load_from_installed_apps(
    ...
    @pytest.mark.django_db
    def test_get_plugin_returns_plugin_when_installed(
        self, installed_apps_with_test_plugin
    ) -> None:
        registry = PluginRegistry()
    ...
    def test_get_plugin_returns_none_when_not_installed(self) -> None:
        registry = PluginRegistry()
        registry.load_from_installed_apps()
    ...
    @pytest.mark.django_db
    def test_get_installed_apps_aggregates_from_plugins(
        self, installed_apps_with_test_plugin
    ) -> None:
    ...
    @pytest.mark.django_db
    def test_get_with_slot_returns_only_slot_entries(self, installed_apps_with_test_plugin) -> None:
    ...
    def test_get_raises_keyerror_for_unknown_key(self) -> None:
    ...
    @pytest.mark.django_db
    def test_get_all_django_extra_settings_merges_dicts(
        self, installed_apps_with_test_plugin
    ) -> None:
    ...
    @pytest.mark.django_db
    def test_get_all_graphql_queries_resolves_strings(
        self, installed_apps_with_test_plugin
    ) -> None:
    ...
    def test_get_all_urlpatterns_resolves_callables(self) -> None:
        registry = PluginRegistry()
        registry.load_from_installed_apps()
    ...
    def test_get_all_v1_urlpatterns_resolves_callables(self) -> None:
        registry = PluginRegistry()
        registry.load_from_installed_apps()
    ...
    @pytest.mark.django_db
    def test_plugin_validation_passes_when_requirements_met(
        self, installed_apps_with_test_plugin
    ) -> None:
        registry = PluginRegistry()

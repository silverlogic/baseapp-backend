...
class TestDocumentIdModel:
    ...
    def test_get_public_id(self) -> None:
        obj = DummyPublicIdModelFactory()
    ...
    def test_get_public_id_returns_none_for_unsaved(self) -> None:
        obj = DummyPublicIdModel(name="bar")
        result = DocumentId.get_public_id_from_object(obj)
        assert result is None

    def test_get_object_by_public_id_returns_object(self) -> None:
        obj = DummyPublicIdModelFactory()
        public_id = DocumentId.get_public_id_from_object(obj)
        found = DocumentId.get_object_by_public_id(public_id)
        assert found == obj

    def test_get_object_by_public_id_with_model_class(self) -> None:
        obj = DummyPublicIdModelFactory()
        public_id = DocumentId.get_public_id_from_object(obj)
        found = DocumentId.get_object_by_public_id(public_id, model_class=obj.__class__)
        assert found == obj

    def test_get_object_by_public_id_wrong_model_class_returns_none(self) -> None:
        obj = DummyPublicIdModelFactory()
        public_id = DocumentId.get_public_id_from_object(obj)
    ...
    def test_get_object_by_public_id_invalid_id_returns_none(self) -> None:

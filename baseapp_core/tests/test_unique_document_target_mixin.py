...
class TestDocumentIdUniqueTargetMixin:
    ...
    def test_target_is_one_to_one_primary_key_to_document_id(self) -> None:
    ...
    def test_get_or_create_for_object_creates_row_and_document_id(self, dummy_instance) -> None:
        metadata = DummyUniqueDocumentTarget.get_or_create_for_object(dummy_instance)
    ...
    def test_get_or_create_for_object_is_idempotent(self, dummy_instance) -> None:
    ...
    def test_get_or_create_for_object_returns_none_for_falsy_object(self) -> None:
        assert DummyUniqueDocumentTarget.get_or_create_for_object(None) is None

    def test_get_or_create_for_object_returns_none_for_unsaved_object(self) -> None:
    ...
    def test_get_for_object_returns_existing_row(self, dummy_instance) -> None:
    ...
    def test_get_for_object_returns_none_when_missing(self, dummy_instance) -> None:
        assert DummyUniqueDocumentTarget.get_for_object(dummy_instance) is None

    def test_get_for_object_returns_none_for_falsy_object(self) -> None:
        assert DummyUniqueDocumentTarget.get_for_object(None) is None

    def test_get_for_object_returns_none_for_unsaved_object(self) -> None:
        unsaved = DummyPublicIdModel(name="unsaved")
        assert DummyUniqueDocumentTarget.get_for_object(unsaved) is None

    def test_row_is_cascade_deleted_with_its_document_id(self, dummy_instance) -> None:
        metadata = DummyUniqueDocumentTarget.get_or_create_for_object(dummy_instance)

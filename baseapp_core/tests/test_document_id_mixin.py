...
class TestDocumentIdMixin:
    ...
    @pytest.fixture
    def dummy_content_type(self) -> ContentType:
        return ContentType.objects.get_for_model(DummyPublicIdModel)

    def test_public_id_property_creates_mapping(self, dummy_instance, dummy_content_type) -> None:
        assert (
    ...
    def test_document_id_deleted_only_for_that_instance(
        self, dummy_instance, dummy_content_type
    ) -> None:
        obj2 = DummyPublicIdModelFactory()
    ...
    def test_document_id_trigger_attached(self) -> None:

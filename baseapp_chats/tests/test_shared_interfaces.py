...
def test_chat_rooms_interface_is_registered_by_name():
    iface = graphql_shared_interfaces.get_interface("ChatRoomsInterface")
    assert iface is ChatRoomsInterface


def test_get_chat_rooms_interface_returns_interface_class():
...
def test_profile_object_type_picks_up_chat_rooms_interface():
